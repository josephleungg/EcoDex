    ...
    return (
        <div className="flex flex-col items-center font-roboto">
            ...
            <div className="flex items-center justify-between">
                <div className="bg-white p-4 h-10 rounded-lg mr-12 flex items-center justify-around drop-shadow-2xl">
                    <img src="/images/eco-coin.png" className="h-6 w-6 mr-2" />
                    <h1 className="text-tertiary-0 font-bold text-2xl">{tokens}</h1>
                </div>
                <div className="bg-white p-4 h-10 rounded-lg flex items-center justify-around drop-shadow-2xl">
                    <img src="/images/bookmark.png" className="h-5 w-5 mr-2" />
                    <h1 className="text-tertiary-0 font-bold text-2xl">{contributions}</h1>
                </div>
            </div>
